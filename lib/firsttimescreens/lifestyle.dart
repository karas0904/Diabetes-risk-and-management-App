...
import 'package:diabeets_app/firsttimescreens/diabetestype.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('Frequency of consuming sugar'),
                  TextField(
                  ...
                  const Text('Physical Activity (in hours)'),
                  TextField(
                    decoration: InputDecoration(
                  ...
                  const SizedBox(height: 15),
                  const Text('Sleep Patterns (in hours)'),
                  TextField(
                    decoration: InputDecoration(
                  ...
                  const SizedBox(height: 15),
                  const Text('Smoking Use'),
                  TextField(
                    decoration: InputDecoration(
                      hintText: "eg: Yes/No", // Hint text inside the text field
                      hintStyle: TextStyle(
                        fontSize: 14.0, // Font size for hint text
                        color: Colors.grey, // Color for hint text (light grey)
                      ), // Prefix text inside the text field
            ...
            SizedBox(height: 100), // Space between the container and the button
            Row(
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              DiabetesTypePage(), // Or another page
                        ));
                  },
                ),
              ],
